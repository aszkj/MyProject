...
@property (nonatomic, assign) CGFloat scorePercent;//得分值，范围为1--5，默认为1
@property (nonatomic, assign) BOOL hasAnimation;//是否允许动画，默认为NO
@property (nonatomic, assign) BOOL allowIncompleteStar;//评分时是否允许不是整星，默认为NO
@property (nonatomic, copy)NSString *originalImgName;
@property (nonatomic, copy)NSString *hilightedImgName;

@property (nonatomic, assign) BOOL isCanbeTouch;//是否可点，默认为NO
