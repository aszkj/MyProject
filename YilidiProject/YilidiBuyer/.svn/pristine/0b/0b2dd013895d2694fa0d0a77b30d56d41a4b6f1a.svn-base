...
- (void)_configureDeduceTransCostUI {
    ...
    NSString *deduceTransCostAmountDisplayStr = !hasShipAmount ? @"暂不免运费" : jFormat(@"(满%ld免运费)",(NSInteger)(self.shopCartViewModel.shopCartStoreModel.deduceTransCostAmount.floatValue/1000));
