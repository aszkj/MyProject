...
@property (weak, nonatomic) IBOutlet UIButton *scanTitleButton;
@property (weak, nonatomic) IBOutlet UIButton *searchButton;
@property (weak, nonatomic) IBOutlet UIButton *searchTitleButton;
...
- (void)awakeFromNib {
    ...
    self.communityLabelWidthConstraint.constant = kScreenWidth*0.67-40;
...
- (void)displayCommunityUI:(BOOL)display {
    ...
    self.scanButton.hidden = self.scanTitleButton.hidden = !display;
    self.searchButton.hidden = self.searchTitleButton.hidden = !display;
    self.communityNameBgView.hidden = !display;
}
