...
#define CalculateItemsRow(itemsTotalCount,oneRowDisplayMaxCount) (itemsTotalCount % oneRowDisplayMaxCount ? (itemsTotalCount / oneRowDisplayMaxCount + 1) : itemsTotalCount / oneRowDisplayMaxCount)
...
#define defineOneKeyValueDic(key,value) @{key:value}
