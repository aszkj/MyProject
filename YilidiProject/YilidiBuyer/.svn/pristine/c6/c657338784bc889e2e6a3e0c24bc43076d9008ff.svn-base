...
typedef void(^CNCompleteBlock)(BOOL isUserClickedToComplete);
typedef void(^CNClickCompleteBlock)();
...
@property (nonatomic,copy) CNClickCompleteBlock clickCompleteBlock;
