...
- (void)setModel:(WSImageModel *)model {
    ...
    if(model.image) {
        ...
        NSString *thumbNailImgUrl = [model.imageUrl getThumbNailImgUrl];
        UIImage *placeHolderImage = [UIImage imageWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:thumbNailImgUrl]]];
