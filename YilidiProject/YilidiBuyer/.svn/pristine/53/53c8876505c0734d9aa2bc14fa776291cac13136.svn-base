...
@property (nonatomic,assign)BOOL isJumpPage;
@end
...
-(void)viewWillAppear:(BOOL)animated {
    ...
    self.goodsSearchTopView.backgroundColor = KSelectedBgColor;
    self.navigationController.navigationBar.barTintColor = KSelectedBgColor;
}
...
//    self.goodsSearchTopView.clearButtonBlock = ^{
//    
//       weak_self.navigationController.navigationBar.barTintColor = [UIColor whiteColor];
//        weak_self.goodsSearchTopView.backgroundColor = [UIColor whiteColor];
//        
//    };
...
- (void)setKeyWords:(NSString *)keyWords {
    ...
    [self.goodsSearchTopView setSearchKeyWords:_keyWords];
    self.goodsSearchTopView.backgroundColor = KSelectedBgColor;
    self.navigationController.navigationBar.barTintColor = KSelectedBgColor;
...
- (DLGoodsSearchShowView *)goodsSearchShowView {
    if (!_goodsSearchShowView) {
        ...
        _goodsSearchShowView.ownVC = self;
        ...
        _goodsSearchShowView.gotoGoodsDetailPageBlock = ^(NSString *goodsId){
            [weak_self _enterGoodsDetailPageWithGoodsId:goodsId];
        };
