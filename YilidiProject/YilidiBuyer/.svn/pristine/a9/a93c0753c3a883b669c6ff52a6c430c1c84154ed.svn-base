...
- (void)_requestData{
    ...
    NSDictionary *requestParam = @{@"typeValue":_type,kRequestPageNumKey:@(self.privilegeTableView.dataLogicModule.requestFromPage), kRequestPageSizeKey:@(kRequestDefaultPageSize)};
    ...
    [AFNHttpRequestOPManager postWithParameters:requestParam subUrl:kUrl_GetMessageType block:^(NSDictionary *resultDic, NSError *error) {
        ...
        [self.privilegeTableView configureTableAfterRequestPagingData:[array mutableCopy]];
