...
@property (nonatomic,copy)NSArray *saleProductImageList;
...
@property (nonatomic,assign)BOOL userHasFavorite;
...
@property (nonatomic,assign) BOOL isShopCartGoodsEditing;

@end

@interface GoodsModel (goodsActivicty)

- (void)configureGoodsActivities:(NSArray *)goodsActivitys;
@property (nonatomic,copy) NSArray* goodsActivitys;
@property (nonatomic,copy) NSString* goodsActivityDescription;

- (CGFloat)goodsActivityDescriptionHeight;

@end

@interface GoodsModel (goodsAsGift)

@property (nonatomic,assign) BOOL isAsGift;
