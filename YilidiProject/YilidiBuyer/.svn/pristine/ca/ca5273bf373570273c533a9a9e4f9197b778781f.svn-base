...
/** --------------可修改(在PYConst.m修改)------------- */
#define PYPlaceholderImage [UIImage imageNamed:@"placeHolder_square"] // 占位图
#define PYLoadFailureImage [UIImage imageNamed:@"placeHolder_square"] // 加载失败图(添加在占位图上大小默认为100 * 100)
