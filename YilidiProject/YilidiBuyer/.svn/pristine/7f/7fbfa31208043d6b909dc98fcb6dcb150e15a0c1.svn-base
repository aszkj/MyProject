...
- (void)setCellTicketType:(SelectTicketType)selectTicketType {
    ...
    NSString *useRangeStr = nil;
    if (selectTicketType == CouponTicket) {
        ticketAmountBgImgName = @"couponRedBg";
        selecteTicketButtonSelectedImgName = @"couponSelectedRed";
        ticketAmountLabelColor = KCOLOR_PROJECT_RED;
        useRangeStr = @"适用范围：";
        useRangeStr = [useRangeStr stringByAppendingString:self.ticketUseRangeLabel.text];
    ...
    self.ticketUseRangeLabel.text = useRangeStr;
