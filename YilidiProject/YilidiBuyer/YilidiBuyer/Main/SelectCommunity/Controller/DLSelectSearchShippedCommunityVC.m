...
-(void)_initaddressAndSelfTakeSwitchView {
    ...
    self.addressAndSelfTakeSwitchView.textColor = UIColorFromRGB(0x333333);
...
-(void)_initShipAdressTableView {
    ...
    self.shipAdressTableView.cellHeight = kAdressListCellHeight;
     self.shipAdressTableView.noDataLogicModule.nodataAlertTitle = @"抱歉，你还没有添加收货地址";
...
- (void)_initSelfTakeTableView {
    ...
    self.selfTakeTableView.noDataLogicModule.nodataAlertTitle = @"附近没有相关自提门店";
