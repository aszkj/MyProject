...
/**
 姓名输入的验证，中文，英文
 */
- (BOOL)sui_validateName
{
    NSString *curRegex = @"^[a-zA-Z\u4e00-\u9fa5]+$";
    BOOL ret = [self sui_validateByRegex:curRegex];
    return ret;
}

/**
 一般输入的验证，中文，英文，数字，中英文标点符号，空格
 */
- (BOOL)sui_validateCommonInputOne
{
    NSString *curRegex = @"[\u4e00-\u9fa5a-zA-Z0-9\u3000-\u301e\ufe10-\ufe19\ufe30-\ufe44\ufe50-\ufe6b\uff01-\uffee]+";
    BOOL ret = [self sui_validateByRegex:curRegex];
    return ret;
}
...
/**
 一般输入的验证，中文，英文，数字,空格
 */
- (BOOL)sui_validateCommonInputTwo
{
    NSString *curRegex = @"[\u4e00-\u9fa5a-zA-Z0-9 ]+";
    BOOL ret = [self sui_validateByRegex:curRegex];
    return ret;
