...
#define PriceMutipl1000(price) @(price.longLongValue*1000)
#define PriceDevide1000(price) @(price.longLongValue/1000)
...
#define NormalGoodsPrice(normalGoodsPrice) [NSString stringWithFormat:@"普通 %@",kDefaultRMBStrWithPrice(normalGoodsPrice)]
#define VIPGoodsPrice(vipPrice) [NSString stringWithFormat:@"VIP %@",kDefaultRMBStrWithPrice(vipPrice)]

#define Higher_Rriority_Constraint_VALUE 999
#define Smaller_Rriority_Constraint_VALUE 998
