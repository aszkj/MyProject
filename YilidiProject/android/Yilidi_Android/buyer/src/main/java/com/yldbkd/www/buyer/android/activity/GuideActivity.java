...
import com.yldbkd.www.buyer.android.fragment.BaseGuideFragment;
import com.yldbkd.www.buyer.android.fragment.FirstGuideFragment;
        ...
        mPagerIndicator.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    mPagerIndicator.setVisibility(position == 2 ? View.GONE : View.VISIBLE);
                }
            }
