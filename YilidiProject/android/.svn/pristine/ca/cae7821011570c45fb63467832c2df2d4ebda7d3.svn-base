...
public class PullToRefreshScrollView extends LinearLayout {
    ...
    private void addFooterView() {
        // footer view
        mFooterView = mInflater.inflate(R.layout.pull_to_refresh_header, this,
                false);
    ...
    private boolean isRefreshViewScroll(int deltaY) {
        ...
        if (mScrollView != null) {
            ...
            if (deltaY > touchSlop && mScrollView.getScrollY() == 0) {
                mPullState = PULL_DOWN_STATE;
                return true;
    ...
    private void headerPrepareToRefresh(int deltaY) {
        ...
        if (mOnRefreshingListener != null) {
            mOnRefreshingListener.onRefreshing(this);
        }
        if (ifHideTop) {
    ...
    private void setHeaderTopMargin(int topMargin) {
        ...
        mHeaderView.setLayoutParams(params);
        if (topMargin == -mHeaderViewHeight && onCompleteListener != null) {
    ...
    public void onHeaderRefreshComplete() {
        setHeaderTopMargin(-mHeaderViewHeight);
        mHeaderImageView.setImageResource(R.mipmap.pulltorefresh_down_arrow);
        if (ifHideTop) {
            mHeaderImageView.setVisibility(View.INVISIBLE);
    ...
    public interface OnFooterRefreshListener {
        void onFooterRefresh(PullToRefreshScrollView view);
    }
    ...
    public interface OnHeaderRefreshListener {
        void onHeaderRefresh(PullToRefreshScrollView view);
    }

    public interface OnRefreshingListener {
        void onRefreshing(PullToRefreshScrollView view);
    }

    public interface OnCompleteListener {
        void onComplete(PullToRefreshScrollView view);
    }

    public void setIfHideTop(boolean ifHideTop) {
        this.ifHideTop = ifHideTop;
        mHeaderImageView.setVisibility(View.INVISIBLE);
        mHeaderTextView.setVisibility(View.INVISIBLE);
        mHeaderProgressBar.setVisibility(View.INVISIBLE);
    }
