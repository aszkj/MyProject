...
import com.yldbkd.www.library.android.zxing.camera.PlanarYUVLuminanceSource;
...
final class DecodeHandler extends Handler {
    ...
    public static final int DECODE = 0x80;
    public static final int QUIT = 0x81;
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        if (rawResult != null) {
            ...
            Message message = Message.obtain(activity.getHandler(), CaptureActivityHandler.DECODE_SUCCESSED, rawResult);
