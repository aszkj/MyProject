 ...
 * 倒计时Button帮助类
 * <p/>
 * Created by Wayne Yang on 15/10/9.
 */
...
public class CountDownHelper {
    ...
    public CountDownHelper(final TextView button,
                           final String defaultString, int max, int interval, int tag) {
        ...
        if (tag == 0) {
            countDownTimer = new CountDownTimer(max * 1000, interval * 1000 - 10) {
                ...
                public void onTick(long time) {
                    ...
                    button.setText("" + ((time + 15) / 1000 + "S后重新获取")
                    );
                }
            ...
            countDownTimer = new CountDownTimer(max * 1000, interval * 1000 - 10) {
                ...
                public void onTick(long time) {
                    ...
                    button.setText("(" + ((time + 15) / 1000) + ")" + defaultString
                    );
