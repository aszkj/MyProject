...
public class WheelView extends View {
     ...
     * 当前条目中的文字颜色
     */
    private static int VALUE_TEXT_COLOR;

    /**
     * 非当前条目的文字颜色
     */
    private static int ITEMS_TEXT_COLOR;
     ...
     */
    private static final int ADDITIONAL_ITEM_HEIGHT = 24;
     ...
     */
    private static int ADDITIONAL_ITEMS_SPACE;
    ...
    private void initData(Context context) {
        ...
        TEXT_SIZE = (int) resources.getDimension(R.dimen.wheel_text_size);

        VALUE_TEXT_COLOR = resources.getColor(R.color.wheel_text_selected);
        ITEMS_TEXT_COLOR = resources.getColor(R.color.wheel_text_light);
        SHADOWS_COLORS = new int[]{resources.getColor(R.color.wheel_text_top), resources.getColor(R.color.wheel_text_shadow)
                , resources.getColor(R.color.wheel_text_shadow)};

        PADDING = (int) resources.getDimension(R.dimen.wheel_padding);
        LABEL_OFFSET = (int) resources.getDimension(R.dimen.wheel_label_offset);
        ADDITIONAL_ITEMS_SPACE = (int) resources.getDimension(R.dimen.wheel_item_space);
        ITEM_OFFSET = -6;
        //创建一个手势处理
