...
public class ClassificationSecondAdapter extends RecyclerView.Adapter<ClassificationSecondAdapter.ViewHolder> {
    ...
    private List<Classification> types;
    private LayoutInflater inflater;

    public ClassificationSecondAdapter(List<Classification> types, Context context) {
        this.types = types;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        Classification classification = types.get(position);
        holder.secondName.setText(classification.getClassName());
        ImageLoaderUtils.load(holder.secondImage, classification.getClassImageUrl());
