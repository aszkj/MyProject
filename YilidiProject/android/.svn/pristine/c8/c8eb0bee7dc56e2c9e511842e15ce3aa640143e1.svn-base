    ...
    public void addLoadingView() {  
        ...
        if (mode == MODE_PULL_UP_TO_REFRESH || mode == MODE_BOTH) {  
            footerLayout = new LoadingLayout(context, MODE_PULL_UP_TO_REFRESH,  
                    releaseUpLabel, pullUpLabel, refreshingUpLabel,false);  
            LayoutParams lp2 = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
            lp2.addRule(RelativeLayout.ALIGN_PARENT_BOTTOM);
            footerLayout.findViewById(R.id.pull_to_refresh_image).setVisibility(View.INVISIBLE);
            footerLayout.findViewById(R.id.pull_to_refresh_progress).setVisibility(View.INVISIBLE);
            footerLayout.findViewById(R.id.pull_to_refresh_text).setVisibility(View.INVISIBLE);
