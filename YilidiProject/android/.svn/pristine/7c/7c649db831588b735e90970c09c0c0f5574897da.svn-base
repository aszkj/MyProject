...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
                ...
                if (isBeingDragged) {
                    ...
                    if (state == RELEASE_TO_REFRESH && null != onRefreshListener) {
                        if (currentMode == MODE_PULL_DOWN_TO_REFRESH) {
                            onRefreshListener.onRefreshPullDown();
                        } else {
                            onRefreshListener.onRefreshPullUp();
                        }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        String pullUpLabel = context.getString(R.string.pullup_to_refresh);
        String pullUpRelease = context.getString(R.string.pullup_to_release);
        ...
        if (mode == MODE_PULL_UP_TO_REFRESH || mode == MODE_BOTH) {
            footerLayout = new LoadingLayout(context, MODE_PULL_UP_TO_REFRESH,
                    pullUpRelease, pullUpLabel, refreshingLabel);
    ...
    public void hideBottom() {
        footerLayout.findViewById(R.id.pull_to_refresh_image).setVisibility(
                View.INVISIBLE);
        footerLayout.findViewById(R.id.pull_to_refresh_text).setVisibility(
                View.INVISIBLE);
        footerLayout.setIfShowBottom(false);
    }
    ...
    public void showBottom() {
        ...
        footerLayout.findViewById(R.id.pull_to_refresh_text).setVisibility(
                View.VISIBLE);
        footerLayout.setIfShowBottom(true);
    }

    public void hideTop() {
        headerLayout.findViewById(R.id.pull_to_refresh_image).setVisibility(
                View.INVISIBLE);
        headerLayout.findViewById(R.id.pull_to_refresh_text).setVisibility(
                View.INVISIBLE);
        headerLayout.setIfShowBottom(false);
    }
}
