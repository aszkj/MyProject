 ...
 */
public abstract class RecyclerBaseAdapter<VH extends RecyclerBaseAdapter.Holder> extends RecyclerView.Adapter<VH> {
        ...
        if (itemClickListener != null) {
            ...
            holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View v) {
                    itemLongClickListener.onItemLongClick(viewHolder.itemView, index);
                    return false;
                }
            });
        }
