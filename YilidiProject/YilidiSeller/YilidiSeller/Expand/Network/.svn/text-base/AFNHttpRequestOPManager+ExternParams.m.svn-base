...
+ (NSString *)_dealDeviceId {
    ...
    NSMutableDictionary *deviceIdDic = (NSMutableDictionary *)[CHKeychain load:DEVICEID_IN_KECHAIN_OF_SELLER];
    NSString *deviceIdInKeyChain = deviceIdDic[DEVICEIDKEY_OF_SELLER];
    if (isEmpty(deviceIdInKeyChain)) {
        ...
        [tempdeviceIdDic setObject:deviceId forKey:DEVICEIDKEY_OF_SELLER];
        [CHKeychain save:DEVICEID_IN_KECHAIN_OF_SELLER data:tempdeviceIdDic];
    }else {
