...
{
    JLog(@"didUpdateUserLocation lat %f,long %f",userLocation.location.coordinate.latitude,userLocation.location.coordinate.longitude);
    _currentLocation = userLocation;
    if (!_isFirstLocation && _baiduLocationBlock) {
...
//        self.location.delegate = self;
    ...
    [self _reversGecodeToCityWithLocation:userLocation.location];
