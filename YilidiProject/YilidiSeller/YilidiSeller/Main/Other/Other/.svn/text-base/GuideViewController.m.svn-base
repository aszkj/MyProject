...
- (void)viewDidLoad
{
    ...
    [button setImage:[UIImage imageNamed:@"LaunchImage"] forState:UIControlStateNormal];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (scrollView.contentOffset.x >= scrollView.frame.size.width * 2 +20) {
        ...
        DLSellerLoginVC *homeVC = [[DLSellerLoginVC alloc] init];
        DLBaseNavController *mainVC = [[DLBaseNavController alloc]initWithRootViewController:homeVC];
