...
@implementation PersonalRecommStoreListRequest
...
{
    return PersonalRecommStoreListResponse.class;
}

- (NSString *) getApiUrl
{
     NSString *url = [NSString stringWithFormat:@"%@/v1/personal/recomm_store/list",self.baseUrl];
    return url;
}
