...
@implementation PersonalOrderDetailsRequest
...
{
    return PersonalOrderDetailsResponse.class;
}

- (NSString *) getApiUrl
{
     NSString *url = [NSString stringWithFormat:@"%@/v1/personal/order/details",self.baseUrl];
    return url;
}
