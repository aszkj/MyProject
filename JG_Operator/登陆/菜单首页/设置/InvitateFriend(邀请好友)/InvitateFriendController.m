...
-(void)showActionSheet {
    ...
    ALActionSheetView *actionSheetView = [ALActionSheetView showActionSheetWithTitle:nil cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@[@"我的二维码",@"邀请明细",@"分享设置"] handler:^(ALActionSheetView *actionSheetView, NSInteger buttonIndex) {
