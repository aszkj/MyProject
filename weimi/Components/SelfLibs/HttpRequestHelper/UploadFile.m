...
//    NSData *data = UIImageJPEGRepresentation(selectedImg, 0.1);
...
//上次图片、语音
-(void)uploadImageWithFileName:(NSString *)fileName withType:(NSString *)type CompleteBlock:(UploadCompleteBlock)block;
{
