...
- (void)_setChildViewConcrollers {
    
    WeimiMainViewController *weimiMainVC = [[WeimiMainViewController alloc] init];
    self.weimiMainNavi = [[XKJHNavRootController alloc] initWithRootViewController:weimiMainVC];
    weimiMainVC.view.backgroundColor = [UIColor redColor];
    
    FoundController *findVC = [[FoundController alloc] init];
    self.findNavi = [[XKJHNavRootController alloc] initWithRootViewController:findVC];
    self.viewControllers = @[_weimiMainNavi,_findNavi];
}
...
{
    if (_tabBarNewMessageBlock) {
        _tabBarNewMessageBlock();
    }
    NewMessageVC *newMessageVC = [[NewMessageVC alloc] init];
    [self.selectedViewController pushViewController:newMessageVC animated:YES];
}
