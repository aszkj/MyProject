...
- (void)initControlBtn {
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.view.frame) - 100, self.view.frame.size.height - 50.0f - self.navHeight, 100, 50)];
