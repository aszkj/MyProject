...
#define kTopBarTypeTableX 0
#define kTopBarTypeTableY (kTopBarHeight+kTableToTopbarGap)
#define kTopBarTypeTableWidth kScreenWidth
#define kTopBarTypeTableHeight (kScreenHeight-kTopBarHeight-kNavBarAndStatusBarHeight-kTableToTopbarGap)

@class BaseTabbarTypeTableView;
...
//每次当前刷新的表
@property (nonatomic, strong)BaseTabbarTypeTableView *currentFreshTableView;
