 ...
 *  @return 刷卡结果
 */
-(NLCardReaderResult *)openCardReaderWithCardReaderModuleTypes:(NSArray*)cardReaderModuleTypes screenShow:(NSString*)screenShow openCardRule:(NLCardRule)openCardRule timeout:(int)timeout;
 ...
 *  @return
 */
- (void)openCardReaderWithCardReaderModuleTypes:(NSArray*)cardReaderModuleTypes screenShow:(NSString*)screenShow openCardRule:(NLCardRule)openCardRule timeout:(int)timeout listener:(id<NLDeviceEventListener>)listener;
