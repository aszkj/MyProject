...
- (void)setupButtons
{
    ...
    [backBtn setImage:IMAGE(@"navigation_back") forState:UIControlStateNormal];
    backBtn.imageView.contentMode = UIViewContentModeScaleAspectFit;
    [backBtn setBackgroundImage:IMAGE(@"navigation_back") forState:UIControlStateHighlighted];
    ...
    finishBtn.frame = CGRectMake(0, 0, 32, 30);
    [finishBtn setTitle:@"完成" forState:UIControlStateNormal];
    [finishBtn setTitleColor:kColorNavText forState:UIControlStateNormal];
    finishBtn.titleLabel.font = [UIFont boldSystemFontOfSize:16];
...
- (void)setupButtons
{
    ...
    if (picker.showCancelButton)
    {
        ...
        cancelBtn.frame = CGRectMake(0, 0, 32, 30);
        [cancelBtn setTitle:NSLocalizedString(@"取消", nil) forState:UIControlStateNormal];
        [cancelBtn setTitleColor:kColorNavText forState:UIControlStateNormal];
...
{
    [super viewDidLoad];
//    UIImage *image = [kGetColor(18, 183, 245) translateIntoImage];
//    UIImage *stretchedImage = [image stretchableImageWithLeftCapWidth:1 topCapHeight:5];
//    [self.navigationBar setBackgroundImage:stretchedImage forBarMetrics:UIBarMetricsDefault];
    self.navigationBar.titleTextAttributes = [NSDictionary dictionaryWithObject:kColorNavText forKey:NSForegroundColorAttributeName];
}
