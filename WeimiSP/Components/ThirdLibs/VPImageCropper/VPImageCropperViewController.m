...
//    self.ratioView.center = self.view.center;
...
- (void)initControlBtn {
    ...
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 50.0f - self.navHeight , 100, 50)];
    ...
    self.title = @"选取";
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.view.frame) - 100, CGRectGetMinY(cancelBtn.frame), 100, 50)];
