...
- (instancetype)init
{
    if (self = [super init])
    {
        ...
        self.navigationBar.backIndicatorImage = [UIImage imageNamed:@"navigation_back"];;
        self.navigationBar.backIndicatorTransitionMaskImage = [UIImage imageNamed:@"navigation_back"];
