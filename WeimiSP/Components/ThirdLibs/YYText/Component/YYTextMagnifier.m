...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    _contentView.layer.cornerRadius = kYYRadius;
    _contentView.clipsToBounds = YES;
    [self addSubview:_contentView];
...
+ (UIImage *)coverImage {
    ...
    dispatch_once(&onceToken, ^{
        ...
        CGPathMoveToPoint(path, NULL, kPadding + kYYRadius, kPadding);
        CGPathAddLineToPoint(path, NULL, size.width - kPadding - kYYRadius, kPadding);
        CGPathAddQuadCurveToPoint(path, NULL, size.width - kPadding, kPadding, size.width - kPadding, kPadding + kYYRadius);
        CGPathAddLineToPoint(path, NULL, size.width - kPadding, kHeight);
        CGPathAddCurveToPoint(path, NULL, size.width - kPadding, kPadding + kHeight, size.width - kPadding - kYYRadius, kPadding + kHeight, size.width - kPadding - kYYRadius, kPadding + kHeight);
        ...
        CGPathAddLineToPoint(path, NULL, size.width / 2 - kArrow, kPadding + kHeight);
        CGPathAddLineToPoint(path, NULL, kPadding + kYYRadius, kPadding + kHeight);
        CGPathAddQuadCurveToPoint(path, NULL, kPadding, kPadding + kHeight, kPadding, kHeight);
        CGPathAddLineToPoint(path, NULL, kPadding, kPadding + kYYRadius);
        CGPathAddQuadCurveToPoint(path, NULL, kPadding, kPadding, kPadding + kYYRadius, kPadding);
