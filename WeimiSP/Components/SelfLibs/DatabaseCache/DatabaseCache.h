...
#define KTableNameOfAcceptOrderMessage       @"t_accept_order_message"
...
@interface DatabaseCache (AcceptOrder)
...
//删除指定信息
- (void)deleteAcceptOrderInfoWithMessageId:(NSNumber *)messageId;
