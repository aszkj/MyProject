...
@property (nonatomic, strong) AcceptOrdeController *mainController;
...
@property (nonatomic) BOOL isConnectingIMserver;          //是否连接到IM服务器
@property (nonatomic, strong) Reachability *reach;
@property (nonatomic) BOOL networkable;    //是否可以联网
@property (nonatomic) BOOL openSound;       //是否开启声音提示


@property (nonatomic) WEMEStoreCustomerServiceBO *userInfo; //用户信息
