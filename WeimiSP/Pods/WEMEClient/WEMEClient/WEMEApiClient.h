 ...
 */
extern NSString *const WEMEResponseObjectErrorKey;

/**
 * Log debug message macro
 */
#define WEMEDebugLog(format, ...) [WEMEApiClient debugLog:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] message: format, ##__VA_ARGS__];

@interface WEMEApiClient : AFHTTPRequestOperationManager

@property(nonatomic, assign) NSURLRequestCachePolicy cachePolicy;
@property(nonatomic, assign) NSTimeInterval timeoutInterval;
@property(nonatomic, readonly) NSOperationQueue* queue;
/// In order to ensure the HTTPResponseHeaders are correct, it is recommended to initialize one WEMEApiClient instance per thread.
...
-(NSNumber*)  requestWithCompletionBlockOAuth2:(NSString*) path
