#import "WEMEConfiguration.h"

@interface WEMEConfiguration ()
...
@implementation WEMEConfiguration

#pragma mark - Singletion Methods

+ (instancetype) sharedConfig {
    static WEMEConfiguration *shardConfig = nil;
