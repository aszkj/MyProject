...
//    self.textColor = UIColorFromRGB(0x8b8b8b);
...
//    UIColor *commonLinkColor = [UIColor colorWithRed:0.112 green:0.000 blue:0.791 alpha:1.000];
    if (_commonLinkColor==nil) {
    _commonLinkColor = UIColorFromRGB(0x299ef1);        
    }
    ...
    if ([NSMutableParagraphStyle class]) {
        [mutableLinkAttributes setObject:_commonLinkColor forKey:(NSString *)kCTForegroundColorAttributeName];
        [mutableActiveLinkAttributes setObject:_commonLinkColor forKey:(NSString *)kCTForegroundColorAttributeName];
        ...
        [mutableLinkAttributes setObject:(__bridge id)[_commonLinkColor CGColor] forKey:(NSString *)kCTForegroundColorAttributeName];
        [mutableActiveLinkAttributes setObject:(__bridge id)[_commonLinkColor CGColor] forKey:(NSString *)kCTForegroundColorAttributeName];
