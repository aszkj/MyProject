...
- (void)_initGoodsCollectionView
{
    ...
    [self.allGoodsCollectionView configureCollectionCellNibName:@"DLCommunityGoodsCollectionViewCell" cellDataSource:nil configureCollectionCellData:^(UICollectionView *collectionView,id collectionModel, UICollectionViewCell *collectionCell) {
...
- (void)_requestGoodsData {
    ...
    [AFNHttpRequestOPManager getInfoWithSubUrl:kUrl_GoodsSearch parameters:requestParam block:^(id result, NSError *error) {
        ...
        [self.allGoodsCollectionView configureTableAfterRequestData:transferedArr];
