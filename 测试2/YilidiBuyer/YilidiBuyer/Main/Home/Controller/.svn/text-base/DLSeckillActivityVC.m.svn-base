...
- (void)_initActivityGoodsListTableView {
    ...
    self.activityGoodsTableView.nodataAlertTitle = @"暂无活动商品";
...
- (void)_addShopCartForGoodsModel:(GoodsModel *)goodsModel withGoodsImgView:(UIImageView *)goodsImageView{
    ...
    [self _performAddShopCartAnimationUsingImgView:goodsImageView withGoodsModel:goodsModel];
}
...
- (void)_alertAddDifferentTypeOfGoodsModel:(GoodsModel *)goodsModel withGoodsImgView:(UIImageView *)goodsImageView{
    ...
    [alertManager showAlertViewWithControllerTitle:@"提示" message:alertStr controllerStyle:UIAlertControllerStyleAlert isHaveTextField:NO actionTitle:@"确定" actionStyle:UIAlertActionStyleDefault alertViewAction:^(UIAlertAction *action) {
        ...
        [weak_self _performAddShopCartAnimationUsingImgView:goodsImageView withGoodsModel:goodsModel];
...
- (void)_performAddShopCartAnimationUsingImgView:(UIImageView *)animationImageView withGoodsModel:(GoodsModel *)goodsModel{
    
    self.activityGoodsTableView.scrollEnabled = NO;
    WEAK_SELF
    [self.animatePerformer performProjectDefaultAddShopCartAnimationForAnimationGoodsImgView:animationImageView animateEndPoint: CGPointMake(kScreenWidth-34-50/2, kScreenHeight-58 - 50/2) animateDidEndBlock:^{
        weak_self.activityGoodsTableView.scrollEnabled = YES;
...
- (void)_requestActivityGoodsList {
    ...
    [AFNHttpRequestOPManager postWithParameters:self.requestParam subUrl:kUrl_GetSekillGoodsList block:^(NSDictionary *resultDic, NSError *error) {
        ...
        [self.activityGoodsTableView configureTableAfterRequestData:activityGoodsList];
