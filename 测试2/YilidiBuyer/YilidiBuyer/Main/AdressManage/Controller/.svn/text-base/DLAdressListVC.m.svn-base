...
-(void)_initRightNewAdressItem {
    ...
    UIBarButtonItem *rightItem = [UIBarButtonItem initWithTitle:@"新建" titleColor:KSelectedBgColor     target:self action:@selector(newAdress)];
...
-(void)_initAddressListTableView {
    ...
    self.addreeListTableView.nodataAlertTitle = @"抱歉，你还没有添加收货地址";
    WEAK_SELF
