...
const CGFloat perCountViewSize = 20;
...
- (void)_setUpUi {
    ...
    [miniteView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(CGSizeMake(perCountViewSize, perCountViewSize));
    }];
    ...
    dotLabelleft.font = kSystemFontSize(12);
    ...
    dotLabelRight.font = kSystemFontSize(12);
...
- (UIView *)_createPerCountDownBgView {
    ...
    perCountDownBgView.layer.cornerRadius = 3.0f;
...
- (UILabel *)_createPerCountDownLabel {
    ...
    perCountDownLabel.font = kSystemFontSize(12.0);
