...
- (void)_initAddressListManageTableView {
    ...
    [self.addreeListTableView configurecellNibName:@"DLAdressManageCell" configurecellData:^(UITableView *tableView,id cellModel, UITableViewCell *cell) {
...
- (void)_setDefaultAdressWithAdressModel:(AdressBaseModel *) model{
...
- (void)_setFirstAdressAsDefaultWhenDefaultAdressDeleted {
    if (self.addreeListTableView.dataLogicModule.currentDataModelArr.count > 0) {
        AdressBaseModel *model = self.addreeListTableView.dataLogicModule.currentDataModelArr.firstObject;
...
- (void)_deleteAdress:(AdressBaseModel *)model {
...
- (void)_comToEditAddressPageWithType:(OperatorAddressType)operatorAddressType addressModel:(AdressBaseModel *)addressModel{
...
- (void)_deleteAdressAressModel:(AdressBaseModel *)adressListModel {
...
- (void)_requestSetDefaultAdressWithAdressModel:(AdressModel *)adressListModel {
    [self showLoadingHub];
    @weakify(self);
...
- (void)_requestDeleteAdressWithAdressModel:(AdressModel *)adressListModel {
    [self showLoadingHub];
    @weakify(self);
