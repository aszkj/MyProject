...
-(void)_initGoodsCollectionView {
    ...
    WEAK_SELF
    [self.goodsCollectionView configureCollectionCellNibName:@"DLOrderGoodsCell" configureCollectionCellData:^(UICollectionView *collectionView,id collectionModel, UICollectionViewCell *collectionCell) {
