...
-(void)_initGoodsCollectionView {
    ...
    WEAK_SELF
    [self.orderGoodsCollectionView configureCollectionCellNibName:@"DLOrderGoodsCell" configureCollectionCellData:^(UICollectionView *collectionView,id collectionModel, UICollectionViewCell *collectionCell) {
