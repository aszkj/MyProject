...
/**
 * 功能描述：账户类型信息实体类，映射数据库表 YiLiDiUserCenter.U_ACCOUNT_TYPE_INFO <br/>
 * 作者：chenl <br/>
 * 
 * BugID: <br/>
 * 修改内容： <br/>
 */
public class AccountTypeInfo extends BaseModel {
	private static final long serialVersionUID = -348870050443020002L;
	/**
	 * 账本类型ID，主键自增长
	 */
