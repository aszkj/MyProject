...
/**
 * 
 * @Description:TODO(店铺商品差价补贴金额转可提现记录：门店与门店商品组合对象，供mybatis使用) 
 * @author:	llp
 * @date:	2015年11月18日 上午21:14:10 
 *
 */
public class StoreProductSubsidyInfo extends BaseModel {
	/** 
	 * @Fields serialVersionUID : TODO(序列号) 
	 */ 
	private static final long serialVersionUID = 1845296598248651784L;
