...
/**
 * 功能描述：用户分享结果 查询DTO封装类 <br/>
 * 作者： chenb <br/>
 * 
 * BugID: <br/>
 * 修改内容： <br/>
 */
public class InvitedUserShareRecordQueryDto extends BaseQueryDto {

    private static final long serialVersionUID = -1504743752468827232L;
