...
/**
 * 功能描述：提现，门店绑定的银行卡账号组合信息<br/>
 * 作者： chenl <br/>
 * 
 * BugID: <br/>
 * 修改内容： <br/>
 */
public class AccountBindingDto extends BaseDto {
    ...
    /**
     * 绑定账户类型名称，通过system_dict 类型accountBindingType获取
     */
    private String accountBindingTypeName;
    /**
     * 开户人姓名
     */
	...
	public String getAccountBindingTypeName() {
		return accountBindingTypeName;
	}
	public void setAccountBindingTypeName(String accountBindingTypeName) {
		this.accountBindingTypeName = accountBindingTypeName;
	}
}
