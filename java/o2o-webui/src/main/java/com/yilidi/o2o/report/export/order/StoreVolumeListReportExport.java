 ...
 * 
 * @author: heyong
 * @date: 2015年12月3日 上午10:20:50
 * 
 */
public class StoreVolumeListReportExport extends AbstractExportReport {

	protected Logger logger = Logger.getLogger(this.getClass());

	private IOrderService orderServiceHessian;

	public StoreVolumeListReportExport() {
		super.reportIndividualRelativePath = "/storevolumelist";
	}
	...
	protected Long obtainDataCount(Object searchArgument) throws ReportException {
		try {
			...
			return orderServiceHessian.getCountsForExportStoreVolumeList(allVolumeStatisticsQuery);
	...
	protected List<?> obtainDataList(Object searchArgument, Long startLineNum, Integer pageSize) throws ReportException {
		try {
			AllVolumeStatisticsQuery allVolumeStatisticsQuery = (AllVolumeStatisticsQuery) searchArgument;
			return orderServiceHessian.listDataForExportStoreVolumeList(allVolumeStatisticsQuery, startLineNum, pageSize);
		} catch (OrderServiceException e) {
	...
	protected int generateHead(Sheet sheet, int rowIndex) throws ReportException {
		try {
			List<Map<String, String>> headers = storeVolumeListReportHeader();
			String mainTitle = "门店销售统计报表";
	 ...
	 */
	public static List<Map<String, String>> storeVolumeListReportHeader() {
