...
//https://github.com/lin-xin
    ...
    function brandSort(){
        ...
        initials();
        $(".initials ul li:first-child").addClass("letterActive");
        $(".initials ul li").click(function(){
            var _this=$(this);
            var LetterHtml=_this.html();
            LetterBox.html(LetterHtml).fadeIn();
            $(".initials ul li").removeClass("letterActive");
            _this.addClass("letterActive");
            setTimeout(function(){
                LetterBox.fadeOut();
            },1000);
        ...
        Initials.find('li').width(LiHeight);
        Initials.find('li').css("line-height",LiHeight+0.56+"px");
    }
