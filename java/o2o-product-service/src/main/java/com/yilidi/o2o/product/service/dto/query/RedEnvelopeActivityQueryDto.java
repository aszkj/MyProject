 ...
 * 
 * @author: chenlian
 * @date: 2016年11月2日 下午4:32:33
 */
public class RedEnvelopeActivityQueryDto extends BaseQueryDto {
    ...
    /**
     * 专题类型编码, 关联系统域系统字典S_STYSTEM_DICT表的DICTCODE字段(DICTTYPE=REDENVELOPEACTIVITYSTATUS)
     */
