 ...
 * 
 */
public class FlittingOrderItemHistoryDto extends BaseDto {

    private static final long serialVersionUID = 121189500890164414L;
    /**
     * 调拨单明细数量变化表ID，主键自增
     */
    private Integer id;
     ...
     * 商品明细
     */
    private FlittingOrderItemDto flittingOrderItemDto;
    ...
    public FlittingOrderItemDto getFlittingOrderItemDto() {
        return flittingOrderItemDto;
    }

    public void setFlittingOrderItemDto(FlittingOrderItemDto flittingOrderItemDto) {
        this.flittingOrderItemDto = flittingOrderItemDto;
    }
