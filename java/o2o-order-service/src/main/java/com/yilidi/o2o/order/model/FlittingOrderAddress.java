...
/**
 * 调货单收货地址信息，映射交易域表YiLiDiOrderCenter.T_FLITTING_ORDER_ADDRESS
 * 
 * @author simpson
 * 
 */
public class FlittingOrderAddress extends BaseModel {

    private static final long serialVersionUID = 1625216950927281637L;
    /**
     * 调拨收货地址ID，主键自增
     */
    private Integer id;
