 ...
 */
public final class UserBindingSmsMessageModel extends SmsMessageModel {
     ...
     */
    private static final String CONTENT_TEMPLATE_NAME_PROPERTIES_KEY = "sms.usebinding.template";
     ...
     */
    private static final String CONTENT_TEMPLATE_VARIABLE_USERBINDING_VALIDTIME = "usebindingValidTime";

    private UserBindingSmsMessageModel(List<String> toUserMobileList, String... variables) {
        ...
        if (StringUtils.isEmpty(variables[1])) {
            throw new IllegalArgumentException("模版中定义的变量：usebindingValidTime 不能为空！");
        }
        ...
        this.contentVariablesMap.put(CONTENT_TEMPLATE_VARIABLE_USERBINDING_VALIDTIME, variables[1]);
    }
