...
/**
 * 
 * @Description:TODO(系统字典DTO)
 * @author: chenlian
 * @date: 2015年11月16日 上午11:16:02
 * 
 */
public class SystemDictDto extends BaseDto {
	...
	private SystemMessageDto newMessage = new SystemMessageDto();
	...
	public SystemMessageDto getNewMessage() {
		return newMessage;
	}

	public void setNewMessage(SystemMessageDto newMessage) {
