...
/**
 * 功能描述：系统字典历时记录实体类，映射系统域表YiLiDiSystemCenter.S_SYSTEM_DICT_HISTORY <br/>
 * 作者：chenl <br/>
 * 
 * BugID: <br/>
 * 修改内容： <br/>
 */
public class SystemDictHistory extends BaseModel {
	private static final long serialVersionUID = 9138139791255194816L;
	/**
	 * 主键ID
	 */
	private Integer id;
