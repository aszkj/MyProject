 ...
 * 
 */
public class PayLogDto extends BaseDto {
     ...
     * 支付平台名称
     */
    private String payPlatformCodeName;
    /**
     * 支付平台流水号
     */
     ...
     * 支付日志状态名称
     */
    private String payLogStatusName;
    /**
     * 支付金额
     */
    ...
    public String getPayPlatformCodeName() {
        return payPlatformCodeName;
    }

    public void setPayPlatformCodeName(String payPlatformCodeName) {
        this.payPlatformCodeName = payPlatformCodeName;
    }
    ...
    public String getPayLogStatusName() {
        return payLogStatusName;
    }

    public void setPayLogStatusName(String payLogStatusName) {
        this.payLogStatusName = payLogStatusName;
    }
    ...
    public String getOperUserTypeName() {
        return operUserTypeName;
    }

    public void setOperUserTypeName(String operUserTypeName) {
        this.operUserTypeName = operUserTypeName;
    }
