package com.yilidi.o2o.core.payment.tencent.protocol.micropay;
...
public class MicroPayReqData {
	 ...
	 */
	public MicroPayReqData(String authCode, String body, String attach, String outTradeNo, int totalFee, String deviceInfo,
			String spBillCreateIP, String timeStart, String timeExpire, String goodsTag, boolean isJsApi) {
