...
/**
 * 类名：HttpProtocolHandler<br>
 * 功能：HttpClient方式访问<br>
 * 详细：获取远程HTTP数据<br>
 * 版本：3.3<br>
 * 日期：2012-08-17<br>
 * 说明：<br>
...
public final class HttpProtocolHandler {
    ...
    private HttpProtocolHandler() {
        ...
        connectionManager.getParams().setDefaultMaxConnectionsPerHost(DEFAULT_MAX_CONN_PER_HOST);
        connectionManager.getParams().setMaxTotalConnections(DEFAULT_MAX_TOTAL_CONN);

        IdleConnectionTimeoutThread ict = new IdleConnectionTimeoutThread();
        ict.addConnectionManager(connectionManager);
        ict.setConnectionTimeout(DEFAULT_IDLE_CONN_TIMEOUT);
