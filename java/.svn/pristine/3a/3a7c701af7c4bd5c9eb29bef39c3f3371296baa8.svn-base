 ...
 * 修改内容： <br/>
 */
public class LogisticSettingDto extends BaseDto {
	...
	/**
	 * 物流区域Map，Key为blockId，Value为以provinceCode为Key，LogisticAreaDto为Value的另一个Map。
	 */
	private Map<Integer, Map<String, LogisticAreaDto>> LogisticAreaMap;
	/**
	 * 物流收费Map，Key为blockId，Value为LogisticChargeDto。
	 */
	private Map<Integer, LogisticChargeDto> LogisticChargeMap;
	...
	public Map<Integer, Map<String, LogisticAreaDto>> getLogisticAreaMap() {
		return LogisticAreaMap;
	}

	public void setLogisticAreaMap(Map<Integer, Map<String, LogisticAreaDto>> logisticAreaMap) {
		LogisticAreaMap = logisticAreaMap;
	}

	public Map<Integer, LogisticChargeDto> getLogisticChargeMap() {
		return LogisticChargeMap;
	}

	public void setLogisticChargeMap(Map<Integer, LogisticChargeDto> logisticChargeMap) {
		LogisticChargeMap = logisticChargeMap;
	}
