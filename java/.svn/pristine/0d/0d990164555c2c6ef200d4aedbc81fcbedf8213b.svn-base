...
public class ReportReqData {
	 ...
	 *            发起接口调用时的机器IP
	 */
	public ReportReqData(String deviceInfo, String interfaceUrl, int executeTimeCost, String returnCode, String returnMsg,
			String resultCode, String errCode, String errCodeDes, String outTradeNo, String userIp, boolean isJsApi) {
