...
@implementation EquipQueryWeekByMonRequest
...
{
    return EquipQueryWeekByMonResponse.class;
}

- (NSString *) getApiUrl
{
     NSString *url = [NSString stringWithFormat:@"%@/v1/equip/queryWeekByMon",self.baseUrl];
    return url;
}
