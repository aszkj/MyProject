...
@interface ShoppingHomeController ()<JGDropdownMenuDelegate>{
...
//    _contentViewArr = @[_happyShoppingView,_gotoStoreExperienceView];
    ...
    //title
    [Util setNavTitleWithTitle:@"周边" ofVC:self];
...
-(void)viewWillAppear:(BOOL)animated {
    ...
    if (_topBarControl.selectedSegmentIndex == 0) {
        //显示城市view
...
//    if (pushCount == 0) {
//        if ([JGActivityTools sharedInstance].shouldShowActivity) {
//            JGDropdownMenu *menu = [JGDropdownMenu menu];
//            menu.delegate = self;
//            __weak typeof(self) bself = self;
//            JGShopActiveContentController *activeController = [[JGShopActiveContentController alloc] initWithPushBlock:^{
//                JGActivityDetailController *activityDetailController = [[JGActivityDetailController alloc] initWithApiBO:apiBo];
//                activityDetailController.hidesBottomBarWhenPushed = YES;
//                [[AFHTTPRequestOperationManager manager].operationQueue cancelAllOperations];
//                
//                
//                [bself.navigationController pushViewController:activityDetailController animated:YES];
//                [bself.dropdownMenu dismiss];
//                [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"isClick"];
//                [[NSUserDefaults standardUserDefaults] synchronize];
//                
//            } closeAction:^{
//                [bself.dropdownMenu dismiss];
//            } imageUrl:apiBo.firstImage];
//            activeController.view.width = ScreenWidth;
//            activeController.view.height = 240;
