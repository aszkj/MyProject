...
typedef void(^GetCodeSuccessBlock)(NSString *code);
typedef void(^GetCodeFailBlock)(void);

@interface JGScanQCodeViewController ()<QRCodeReaderViewDelegate,AVCaptureMetadataOutputObjectsDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate,UIAlertViewDelegate>
{
...
@property (copy , nonatomic) GetCodeSuccessBlock codeBlock;
@property (copy , nonatomic)  GetCodeFailBlock  getCodeFailBlock;


//http://weixin.qq.com/r/l182LlnEcQQOrR1N9wqF

@end

@implementation JGScanQCodeViewController
...
//    self.navigationItem.rightBarButtonItem = rbbItem;
    ...
    backButton.frame = CGRectMake(0, 0, 61, 40);
