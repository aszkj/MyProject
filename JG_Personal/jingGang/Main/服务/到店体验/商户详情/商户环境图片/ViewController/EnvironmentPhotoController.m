...
- (void)viewDidLoad {
    ...
    CGRect frame = CGRectMake(0, 0, __MainScreen_Width, __MainScreen_Height - kTopBarHeight);
    
    UICollectionViewFlowLayout *flowLayout= [[UICollectionViewFlowLayout alloc] init];
    flowLayout.footerReferenceSize = CGSizeMake(__MainScreen_Width, 36);
...
- (void)initUI
{
    ...
    _cellWidth = (__MainScreen_Width-kEdgeInsetLeft-kEdgeInsetRight-kMinimumInteritemSpacing)/2;
}
...
//    [Util setTitleViewWithTitle:@"商户环境图片" andNav:self.navigationController];
    self.title = @"商户环境";
}
