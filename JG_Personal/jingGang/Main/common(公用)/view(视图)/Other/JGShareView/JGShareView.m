                   ...
                   shareImagePath:(NSString *)shareImagePath
{
    ...
    TencentShareModel *tencentShareModel = [[TencentShareModel alloc] init];
    ...
    jgshareView.tencentShareModel = tencentShareModel;
    ...
    [[self class] _setEveryShareModel:jgshareView.tencentShareModel withBaseShareModel:shareModel];
...
//        jShareView.shareView.shareUrl = jShareView.weiBoShareModel.shareUlrStr;
    ...
    jgShareView.shareView.tencentShareBlock = ^{
        [[self class] _setShareModelContent:jShareView.tencentShareModel withJGShareView:jShareView];
    };
...
@implementation TencentShareModel
