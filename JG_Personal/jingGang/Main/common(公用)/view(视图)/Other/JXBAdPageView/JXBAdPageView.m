...
- (void)initUI {
    ...
    _pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.frame.size.height-15 , self.frame.size.width, 0)];
//    _pageControl.currentPageIndicatorTintColor = [UIColor redColor];
//    _pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:94/255.0 green:130/255.0 blue:231/255.0 alpha:1];
