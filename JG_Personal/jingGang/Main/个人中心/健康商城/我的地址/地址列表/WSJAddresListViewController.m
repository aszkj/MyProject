...
- (void) requestDataApiID:(NSNumber *)apiID
{
    ...
    [_vapiManager shopAddresList:request success:^(AFHTTPRequestOperation *operation, ShopAddresListResponse *response) {
        ...
        {
            [weak_self.dataSource addObject:d];
        }
...
{
    UIView *view= [[UIView alloc] initWithFrame:CGRectMake(0, 0, __MainScreen_Width, 41)];
    view.backgroundColor = [UIColor whiteColor];
    UIView *xian = [[UIView alloc] initWithFrame:CGRectMake(0, 40.5, __MainScreen_Width, 0.5)];
