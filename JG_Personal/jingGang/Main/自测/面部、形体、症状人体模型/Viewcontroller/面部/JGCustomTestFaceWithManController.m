//
//  JGCustomTestFaceWithManController.m
//  jingGang
//
...
@interface JGCustomTestFaceWithManController ()<UIWebViewDelegate>
@property (strong,nonatomic) UIWebView *web;

@end

@implementation JGCustomTestFaceWithManController
...
- (void)viewDidLoad {
    ...
    NSString *adUrl = [NSString stringWithFormat:@"%@",Figure_Man_H5];
...
-(void)makeJsEnvirement {
    ...
    context[@"requestFace"] = ^(){
        ...
        JGFaceManViewController *manFaceController =[[JGFaceManViewController alloc] init];
        [self.navigationController pushViewController:manFaceController animated:YES];
    };
}
