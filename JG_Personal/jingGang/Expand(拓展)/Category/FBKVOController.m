...
#pragma mark API -
- (void)observe:(id)object keyPath:(NSString *)keyPath block:(FBKVONewValueBlock)block {
    [self observe:object keyPath:keyPath options:NSKeyValueObservingOptionInitial|NSKeyValueObservingOptionNew block:^(id observer, id object, NSDictionary *change) {
