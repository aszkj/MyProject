...
//        SEL swizzledSelector = NSSelectorFromString([@"rt_" stringByAppendingString:NSStringFromSelector(originalSelector)]);
//        
...
//}
//
//- (void)rt_drawRect:(CGRect)rect
//{
//    [self rt_drawRect:rect];
//}

- (void)addTopAndBottomLine:(UIColor *)lineColor
{
