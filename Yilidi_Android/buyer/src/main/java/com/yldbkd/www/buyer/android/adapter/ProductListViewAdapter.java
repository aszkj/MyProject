...
public class ProductListViewAdapter extends BaseAdapter {
    ...
    public ProductListViewAdapter(List<SaleProduct> list, Context context, Integer parentPosition, Handler handler) {
        this.list = list;
        ...
        switch (getItemViewType(position)) {
            case COMMON:
                if (convertView == null) {
                    ...
                    convertView = inflater.inflate(R.layout.product_item_listview, parent, false);
