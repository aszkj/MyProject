...
public abstract class HttpBack<T> implements Callback<CallbackBean> {
    ...
    private Context context = BuyerApp.getInstance().getApplicationContext();
    private WeakReference<BaseActivity> activityWeakReference;

    public HttpBack() {}

    public HttpBack(BaseActivity baseActivity) {
    ...
    public void success(CallbackBean callbackBean, Response response) {
        ...
        switch (msgBean.getMsgCode()) {
            ...
            case MsgBean.UPDATE:
                ...
                if (activity != null) {
                    UpdateManager.getUpdateManager().checkAppUpdate(activity, null);
                }
                break;
    ...
    private MsgBean<T> getMsg(CallbackBean callbackBean) {
        ...
        //        if (!BuyerApp.getInstance().getJsonKey().equals(msgBean.getKey())) {
